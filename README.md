...
Backend- MongoDb | Express | Nestjs | Nodejs | Flask | Python | Java | Spring Boot | socket.io | MySql | Postgresql | Redis | Docker | Prisma | microservices | rabbitmq | kafka | twilio
